...
if ($validar==2) {
  ...
  $descripcion_o = $_POST['descripcion_o'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre_o`='$nombre_o',`descripcion_o`='$descripcion_o' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
    echo 1;
...
if ($validar==3) {
  ...
  $descripcion_f = $_POST['descripcion_f'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre_f`='$nombre_f',`descripcion_f`='$descripcion_f' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
    echo 1;
...
if ($validar==4) {
  ...
  $descripcion_a = $_POST['descripcion_a'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre_a`='$nombre_a',`descripcion_a`='$descripcion_a' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
    echo 1;
...
if ($validar==5) {
  ...
  $descripcion_d = $_POST['descripcion_f'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre__f`='$nombre_d',`descripcion__f`='$descripcion_d' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
   echo 1;
}
if ($validar==6) {
  $nombre_o = $_POST['nombre_o'];
  $descripcion_o = $_POST['descripcion_o'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre__o`='$nombre_o',`descripcion__o`='$descripcion_o' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
    echo 1;  
...
if ($validar==7) {
  ...
  $descripcion_f = $_POST['descripcion_d'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre__d`='$nombre_f',`descripcion__d`='$descripcion_f' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
    echo 1;
...
if ($validar==8) {
  ...
  $descripcion_a = $_POST['descripcion_a'];
    ...
    $dofa_verificacion = consulta($miconexion, "ALTER TABLE dofa AUTO_INCREMENT=1");
    //codigo por realizar cambiandoel 1 por un valor de la consulta cuando se valide cuales el valor max
    $dofa_resultado = consulta($miconexion, "UPDATE `dofa` SET `nombre__a`='$nombre_a',`descripcion__a`='$descripcion_a' WHERE id_user_dofa like '{$_SESSION['id_usuario']}'");
    echo 1;
