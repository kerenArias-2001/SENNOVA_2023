...
$(document).ready(function () {
	...
	function actualizardatos() {
	    	$.ajax({
			url: "../assets/php/informacion.php", // Archivo PHP que obtiene los datos del servidor

			success: function (data) {
		//	console.log(data); // Actualizar el contenido de la tabla con los datos recibidos
			},
		});
		$.ajax({
